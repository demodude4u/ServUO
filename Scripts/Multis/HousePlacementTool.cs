...
namespace Server.Items
{
    ...
    public class HousePlacementEntry
    {
        ...
        private static readonly HousePlacementEntry[] m_HousesEJ =
        {
            ...
            new HousePlacementEntry(typeof(TrinsicKeep),                1158748,	2625,	1312,	3019,	1509,	52,	1000000, 0, 11,	0,	0x147E),
            new HousePlacementEntry(typeof(GothicRoseCastle),           1158749,	4076,	2038,	4688,	2344,	78, 2000000, 0, 16,	0,	0x147F),
            new HousePlacementEntry(typeof(ElsaCastle),                 1158750,	4076,	2038,	4688,	2344,	78, 2000000, 0, 16,	0,	0x1480),
            new HousePlacementEntry(typeof(Spires),                     1158761,	4076,	2038,	4688,	2344,	78, 2000000, 0, 16,	0,	0x1481),
            new HousePlacementEntry(typeof(CastleOfOceania),            1158760,	4076,	2038,	4688,	2344,	78, 2000000, 0, 16,	0,	0x1482),
            new HousePlacementEntry(typeof(FeudalCastle),               1158762,	4076,	2038,	4688,	2344,	78, 2000000, 0, 16,	0,	0x1483),
            new HousePlacementEntry(typeof(RobinsNest),                 1158850,	2625,	1312,	3019,	1509,	52, 1000000, 0, 11,	0,	0x1484),
            new HousePlacementEntry(typeof(TraditionalKeep),            1158851,	2625,	1312,	3019,	1509,	52, 1000000, 0, 11,	0,	0x1485),
            new HousePlacementEntry(typeof(VillaCrowley),               1158852,	2625,	1312,	3019,	1509,	52, 1000000, 0, 11,	0,	0x1486),
            new HousePlacementEntry(typeof(DarkthornKeep),              1158853,	2625,	1312,	3019,	1509,	52, 1000000, 0, 11,	0,	0x1487),
            new HousePlacementEntry(typeof(SandalwoodKeep),             1158854,	2625,	1312,	3019,	1509,	52, 1000000, 0, 11,	0,	0x1488),
            new HousePlacementEntry(typeof(CasaMoga),                   1158855,	2625,	1312,	3019,	1509,	52, 1000000, 0, 11,	0,	0x1489),

            new HousePlacementEntry(typeof(RobinsRoost),                1158960,    4076,   2038,   4688,   2344,   78,	2000000, 0, 16,	0,	0x148A),
            new HousePlacementEntry(typeof(Camelot),                    1158961,    4076,   2038,   4688,   2344,   78, 2000000, 0, 16,	0,  0x148B),
            new HousePlacementEntry(typeof(LacrimaeInCaelo),            1158962,    4076,   2038,   4688,   2344,   78, 2000000, 0, 16,	0,  0x148C),
            new HousePlacementEntry(typeof(OkinawaSweetDreamCastle),    1158963,    4076,   2038,   4688,   2344,   78, 2000000, 0, 16,	0,  0x148D),
            new HousePlacementEntry(typeof(TheSandstoneCastle),         1158964,    4076,   2038,   4688,   2344,   78, 2000000, 0, 16,	0,  0x148E),
            new HousePlacementEntry(typeof(GrimswindSisters),           1158965,    4076,   2038,   4688,   2344,   78, 2000000, 0, 16, 0,  0x148F),
        };
