...
{
	public class AssaultGuard : CrimeGuard
	{
		...
		public AssaultGuard(Mobile target)
			: base(target)
		{
			Title = "the guard";
		...
		public AssaultGuard(Serial serial)
			: base(serial)
		{ }
		...
		{
			private readonly AssaultGuard m_Owner;
			//	private bool m_Shooting;
			public AttackTimer(AssaultGuard owner)
		...
		private class IdleTimer : Timer
		{
			...
			public IdleTimer(AssaultGuard owner)
