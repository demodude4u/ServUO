...
{
	public class UnlimitedMustasheGrowthElixir : Item
	{
		[Constructable]
		public UnlimitedMustasheGrowthElixir() : base( 3841 )
		{
            Name = "Mustashe growth elixir";
		}
		public UnlimitedMustasheGrowthElixir( Serial serial ) : base( serial )
		{
		}
