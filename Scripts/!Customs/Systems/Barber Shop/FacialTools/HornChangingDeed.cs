...
{
	public class HornChangingDeed : Item
	{

		[Constructable]
		public HornChangingDeed() : base( 0x14F0 )
		{
			Weight = 1.0;
        ...
        public HornChangingDeed(Serial serial)
            : base(serial)
		{
		}
		...
		private class InternalGump : Gump
		{
            ...
            private HornChangingDeed m_Deed;

            public InternalGump(Mobile from, HornChangingDeed deed)
                : base(50, 50)
			{
				m_From = from;
				m_Deed = deed;
...
*/
			...
			int[][] LayoutArray =
			{
				...
				new int[] { 235, 225, 150, 240, 145, 185, 118, 238 },	// Horn Style 4
