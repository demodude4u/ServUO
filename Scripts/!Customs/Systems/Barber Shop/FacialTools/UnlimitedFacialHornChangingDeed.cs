...
{
	public class UnlimitedFacialHornChangingDeed : Item
	{

		[Constructable]
		public UnlimitedFacialHornChangingDeed() : base( 0x14F0 )
		{
			Weight = 1.0;
        ...
        public UnlimitedFacialHornChangingDeed(Serial serial)
            : base(serial)
		{
		}
		...
		private class InternalGump : Gump
		{
            ...
            private UnlimitedFacialHornChangingDeed m_Deed;

            public InternalGump(Mobile from, UnlimitedFacialHornChangingDeed deed)
                : base(50, 50)
			{
				m_From = from;
				m_Deed = deed;
