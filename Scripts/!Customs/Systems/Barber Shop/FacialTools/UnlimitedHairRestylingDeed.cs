...
{
	public class UnlimitedHairRestylingDeed : Item
	{
		public override int LabelNumber{ get{ return 1041061; } } // a coupon for a free hair restyling

		[Constructable]
		public UnlimitedHairRestylingDeed() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public UnlimitedHairRestylingDeed( Serial serial ) : base( serial )
		{
		}
		...
		private class InternalGump : Gump
		{
			...
			private UnlimitedHairRestylingDeed m_Deed;

			public InternalGump( Mobile from, UnlimitedHairRestylingDeed deed ) : base( 50, 50 )
			{
				m_From = from;
				m_Deed = deed;
