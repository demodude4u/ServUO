...
namespace Server.Customs.Invasion_System
{
	public class MonsterTownSpawnEntry
	{
        ...
        public static MonsterTownSpawnEntry[] UndeadNewbie = new MonsterTownSpawnEntry[]
        {
			//Monster													//Amount
			new MonsterTownSpawnEntry( typeof( Zombie ),                        25 ),
            new MonsterTownSpawnEntry( typeof( Skeleton ),                      25 ),
            new MonsterTownSpawnEntry( typeof( Ghoul ),                         25 ),
            new MonsterTownSpawnEntry( typeof( Wraith ),                        10 ),
            new MonsterTownSpawnEntry( typeof( Spectre ),                       10 ),
            new MonsterTownSpawnEntry( typeof( Shade ),                         10 ),
            new MonsterTownSpawnEntry( typeof( BoneKnight ),                    7 ),
            new MonsterTownSpawnEntry( typeof( SkeletalKnight ),                7 ),
            new MonsterTownSpawnEntry( typeof( BoneMagi ),                      5 ),
            new MonsterTownSpawnEntry( typeof( SkeletalMage ),                  5 ),
            new MonsterTownSpawnEntry( typeof( Lich ),                          3 ),
