    ...
    public class PMList
    {
        public static readonly PMList Trammel = new PMList(
            ...
            new[]
            {
					...
					new PMEntry( new Point3D( 1336, 1997,   5 ), "Britain" ),
					new PMEntry( new Point3D( 1499, 3771,   5 ), "Jhelom" ),
					new PMEntry( new Point3D(  771,  752,   5 ), "Yew" ),
					new PMEntry( new Point3D( 2701,  692,   5 ), "Minoc" ),
					new PMEntry( new Point3D( 1828, 2948, -20 ), "Trinsic" ),
					new PMEntry( new Point3D( 2915,  611,   0 ), "Vesper" ),
					new PMEntry( new Point3D(  643, 2067,   5 ), "Skara Brae" ),
					new PMEntry( new Point3D( 3450, 2677,  25 ), "New Haven" ),
					new PMEntry( new Point3D( 2243, 1214,   0 ), "Cove" ),
					new PMEntry( new Point3D( 3679, 2268,  26 ), "Magincia" ),
					new PMEntry( new Point3D( 3767, 1295,   0 ), "Nujel'm" ),
					new PMEntry( new Point3D( 2711, 2234,   0 ), "Buccaneer's Den" ),
					new PMEntry( new Point3D( 3032, 3406,  23 ), "Serpent's Hold" ),
					new PMEntry( new Point3D( 4545, 2316,  -2 ), "Sea Market" ),
					new PMEntry( new Point3D( 5276, 3945,  37 ), "Delucia" ),
					new PMEntry( new Point3D( 5745, 3313,  -3 ), "Papua" )
        ...
        public static readonly PMList Felucca = new PMList(
            ...
            new[]
            {
					...
					new PMEntry( new Point3D( 2915,  611,   0 ), "Vesper" ),
					new PMEntry( new Point3D(  643, 2067,   5 ), "Skara Brae" ),
					new PMEntry( new Point3D( 3650, 2516,   0 ), "Ocllo" ),
					new PMEntry( new Point3D( 2243, 1214,   0 ), "Cove" ),
					new PMEntry( new Point3D( 3679, 2268,  26 ), "Magincia" ),
					new PMEntry( new Point3D( 3767, 1295,   0 ), "Nujel'm" ),
					new PMEntry( new Point3D( 2711, 2234,   0 ), "Buccaneer's Den" ),
