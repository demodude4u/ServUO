...
namespace Server.Scripts.Commands
{
    ...
    public class FireFeet
    {
        ...
        public static void Initialize()
        {
            ...
            CommandHandlers.Register( "FireFeet", AccessLevel.Counselor, new CommandEventHandler( FireFeet_OnCommand ) );
            CommandHandlers.Register( "FireFeetSettings", AccessLevel.Counselor, new CommandEventHandler( FireFeetSettings_OnCommand ) );
